...
// Type: Microsoft.Scripting.Interpreter.FuncCallInstruction`10
...
internal sealed class FuncCallInstruction<T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet> : CallInstruction
{
  ...
  public FuncCallInstruction(
    Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet> target)
  {
    this._target = target;
  }
  ...
  public override object Invoke(
    ...
    object arg8)
  {
    return (object) this._target(arg0 != null ? (T0) arg0 : default (T0), arg1 != null ? (T1) arg1 : default (T1), arg2 != null ? (T2) arg2 : default (T2), arg3 != null ? (T3) arg3 : default (T3), arg4 != null ? (T4) arg4 : default (T4), arg5 != null ? (T5) arg5 : default (T5), arg6 != null ? (T6) arg6 : default (T6), arg7 != null ? (T7) arg7 : default (T7), arg8 != null ? (T8) arg8 : default (T8));
  }

  public override int Run(InterpretedFrame frame)
  {
    frame.Data[frame.StackIndex - 9] = (object) this._target((T0) frame.Data[frame.StackIndex - 9], (T1) frame.Data[frame.StackIndex - 8], (T2) frame.Data[frame.StackIndex - 7], (T3) frame.Data[frame.StackIndex - 6], (T4) frame.Data[frame.StackIndex - 5], (T5) frame.Data[frame.StackIndex - 4], (T6) frame.Data[frame.StackIndex - 3], (T7) frame.Data[frame.StackIndex - 2], (T8) frame.Data[frame.StackIndex - 1]);
    frame.StackIndex -= 8;
    return 1;
  }
}
