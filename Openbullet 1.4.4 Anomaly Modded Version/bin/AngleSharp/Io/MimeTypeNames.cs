...
// Type: AngleSharp.Io.MimeTypeNames
...
{
  private static readonly string[] CommonJsTypes = new string[16 /*0x10*/]
  {
  ...
  {
    string str;
    return MimeTypeNames.Extensions.TryGetValue(extension, out str) ? str : MimeTypeNames.Binary;
  }

  public static string GetExtension(string mimeType)
  {
    return MimeTypeNames.Extensions.FirstOrDefault<KeyValuePair<string, string>>((Func<KeyValuePair<string, string>, bool>) (x => x.Value.Isi(mimeType))).Key ?? string.Empty;
  }
