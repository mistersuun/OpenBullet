...
// Type: AngleSharp.Css.Dom.LastTypeSelector
...
internal sealed class LastTypeSelector(int step, int offset, ISelector kind) : 
  ChildSelector(PseudoClassNames.NthLastOfType, step, offset, kind),
  ISelector
{
