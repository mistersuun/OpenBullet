...
// Type: AngleSharp.Css.Dom.AttrContainsSelector
...
internal sealed class AttrContainsSelector : BaseAttrSelector, ISelector
{
  ...
  {
    return !string.IsNullOrEmpty(this._value) && (element.GetAttribute(this.Name) ?? string.Empty).IndexOf(this._value, this._comparison) != -1;
  }
}
