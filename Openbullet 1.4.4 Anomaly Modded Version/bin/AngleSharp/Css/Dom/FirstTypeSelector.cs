...
// Type: AngleSharp.Css.Dom.FirstTypeSelector
...
internal sealed class FirstTypeSelector(int step, int offset, ISelector kind) : 
  ChildSelector(PseudoClassNames.NthOfType, step, offset, kind),
  ISelector
{
