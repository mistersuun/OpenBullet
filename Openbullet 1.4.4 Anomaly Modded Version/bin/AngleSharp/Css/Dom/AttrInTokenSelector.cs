...
// Type: AngleSharp.Css.Dom.AttrInTokenSelector
...
internal sealed class AttrInTokenSelector : BaseAttrSelector, ISelector
{
  ...
  {
    return !string.IsNullOrEmpty(this._value) && (element.GetAttribute(this.Name) ?? string.Empty).HasHyphen(this._value, this._comparison);
  }
}
