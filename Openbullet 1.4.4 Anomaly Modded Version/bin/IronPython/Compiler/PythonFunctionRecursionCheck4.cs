...
// Type: IronPython.Compiler.PythonFunctionRecursionCheck4
...
internal class PythonFunctionRecursionCheck4
{
  ...
  public PythonFunctionRecursionCheck4(
    Func<PythonFunction, object, object, object, object, object> target)
  {
    this._target = target;
  }
    ...
    object arg3)
  {
    try
    {
      ...
      return this._target(function, arg0, arg1, arg2, arg3);
    }
    finally
    {
