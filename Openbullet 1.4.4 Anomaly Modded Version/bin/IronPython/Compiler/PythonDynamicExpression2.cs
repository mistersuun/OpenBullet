...
// Type: IronPython.Compiler.PythonDynamicExpression2
...
internal class PythonDynamicExpression2 : LightDynamicExpression2
{
  ...
  {
    return (Expression) new PythonDynamicExpression2(binder, this._mode, arg0, arg1);
  }
  ...
  public override void AddInstructions(LightCompiler compiler)
  {
    ...
    else if (this.Argument1.Type == typeof (CodeContext))
    {
      compiler.Compile(this.Argument0);
      compiler.Compile(this.Argument1);
      compiler.Instructions.EmitDynamic<object, CodeContext, object>(this.Binder);
    }
    else
