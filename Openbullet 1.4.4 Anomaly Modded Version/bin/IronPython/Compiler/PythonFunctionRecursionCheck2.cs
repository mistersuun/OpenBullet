...
// Type: IronPython.Compiler.PythonFunctionRecursionCheck2
...
internal class PythonFunctionRecursionCheck2
{
  ...
  public PythonFunctionRecursionCheck2(
    Func<PythonFunction, object, object, object> target)
  {
    this._target = target;
  }
  ...
  public object CallTarget(PythonFunction function, object arg0, object arg1)
  {
    try
    {
      ...
      return this._target(function, arg0, arg1);
    }
    finally
    {
