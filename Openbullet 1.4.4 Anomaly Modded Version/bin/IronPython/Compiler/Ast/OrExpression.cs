...
// Type: IronPython.Compiler.Ast.OrExpression
...
public class OrExpression : Expression
{
  ...
  public override System.Linq.Expressions.Expression Reduce()
  {
    ...
    {
      parameterExpression
    }, (System.Linq.Expressions.Expression) System.Linq.Expressions.Expression.Condition(this.GlobalParent.Convert(typeof (bool), ConversionResultKind.ExplicitCast, (System.Linq.Expressions.Expression) System.Linq.Expressions.Expression.Assign((System.Linq.Expressions.Expression) parameterExpression, Microsoft.Scripting.Ast.Utils.Convert(left, type))), (System.Linq.Expressions.Expression) parameterExpression, Microsoft.Scripting.Ast.Utils.Convert(right, type)));
  }
  ...
  public override Type Type
  {
    get
    {
      ...
      return !(type == this._right.Type) ? typeof (object) : type;
    }
  }
