...
// Type: IronPython.Runtime.Exceptions.UnicodeTranslateException
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      if (this._pyExceptionObject == null)
      {
        ...
        unicodeTranslateError.InitializeFromClr((Exception) this);
        this._pyExceptionObject = (object) unicodeTranslateError;
      }
