...
// Type: IronPython.Runtime.Exceptions.RuntimeException
...
public class RuntimeException : Exception, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.RuntimeError);
