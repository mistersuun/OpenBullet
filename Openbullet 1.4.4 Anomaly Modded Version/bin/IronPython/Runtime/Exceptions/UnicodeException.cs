...
// Type: IronPython.Runtime.Exceptions.UnicodeException
...
public class UnicodeException : Exception, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.UnicodeError);
