...
// Type: IronPython.Runtime.Exceptions.EnvironmentException
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      if (this._pyExceptionObject == null)
      {
        ...
        environmentError.InitializeFromClr((Exception) this);
        this._pyExceptionObject = (object) environmentError;
      }
