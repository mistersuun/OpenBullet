...
// Type: IronPython.Runtime.Exceptions.TypeErrorException
...
public class TypeErrorException : ArgumentTypeException, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.TypeError);
