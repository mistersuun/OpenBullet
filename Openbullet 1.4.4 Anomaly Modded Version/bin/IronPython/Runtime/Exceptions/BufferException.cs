...
// Type: IronPython.Runtime.Exceptions.BufferException
...
public class BufferException : Exception, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.BufferError);
