...
internal class JsonSerializerInternalReader(JsonSerializer serializer) : JsonSerializerInternalBase(serializer)
{
    ...
    out bool gottenCurrentValue)
  {
    ...
    if ((property.ObjectCreationHandling ?? this.Serializer._objectCreationHandling) != ObjectCreationHandling.Replace && (tokenType == JsonToken.StartArray || tokenType == JsonToken.StartObject) && property.Readable)
    {
      currentValue = property.ValueProvider.GetValue(target);
  ...
  {
    return ((property.NullValueHandling ?? this.Serializer._nullValueHandling) != NullValueHandling.Ignore || value != null) && (!this.HasFlag(property.DefaultValueHandling ?? this.Serializer._defaultValueHandling, DefaultValueHandling.Ignore) || this.HasFlag(property.DefaultValueHandling ?? this.Serializer._defaultValueHandling, DefaultValueHandling.Populate) || !MiscellaneousUtils.ValueEquals(value, property.GetResolvedDefaultValue())) && property.Writable;
  }
