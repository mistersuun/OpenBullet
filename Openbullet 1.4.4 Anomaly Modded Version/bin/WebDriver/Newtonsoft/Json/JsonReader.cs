    ...
    switch (contentToken)
    {
      ...
      case JsonToken.Float:
        if (!(this.Value is Decimal))
          this.SetToken(JsonToken.Float, (object) (!(this.Value is BigInteger) ? Convert.ToDecimal(this.Value, (IFormatProvider) CultureInfo.InvariantCulture) : (Decimal) (BigInteger) this.Value), false);
