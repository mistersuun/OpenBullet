...
public static class Http
{
  ...
  public static string ChromeUserAgent()
  {
    ...
    return $"Mozilla/5.0 ({Http.RandomWindowsVersion()}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str1} Safari/{str2}";
  }
  ...
  private static char IntToHex(int i) => i <= 9 ? (char) (i + 48 /*0x30*/) : (char) (i - 10 + 65);
