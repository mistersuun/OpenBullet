...
// Type: Extreme.Net.Socks5ProxyClient
...
public class Socks5ProxyClient : ProxyClient
{
  ...
  private const byte AuthMethodIanaAssignedRangeEnd = 127 /*0x7F*/;
  private const byte AuthMethodReservedRangeBegin = 128 /*0x80*/;
    ...
    int destinationPort)
  {
    ...
    portBytes.CopyTo((Array) buffer1, 4 + addressBytes.Length);
    nStream.Write(buffer1, 0, buffer1.Length);
