  ...
  internal static BigInteger ToBigInteger(object value)
  {
    ...
    switch (value)
    {
      ...
      default:
        ...
        return value is byte[] numArray ? new BigInteger(numArray) : throw new InvalidCastException("Cannot convert {0} to BigInteger.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) value.GetType()));
    }
  }
