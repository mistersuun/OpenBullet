  ...
  ICollection
{
  ...
  public bool Contains(KeyValuePair<TKey, TValue> item)
  {
    ...
    return this._readOnlyDictionary != null ? ((IEnumerable<KeyValuePair<TKey, TValue>>) this._readOnlyDictionary).Contains<KeyValuePair<TKey, TValue>>(item) : this._genericDictionary.Contains(item);
  }
  ...
  public int Count
  {
    get
    {
      ...
      return this._readOnlyDictionary != null ? ((IReadOnlyCollection<KeyValuePair<TKey, TValue>>) this._readOnlyDictionary).Count : this._genericDictionary.Count;
    }
  }
  ...
  public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator()
  {
    ...
    return this._readOnlyDictionary != null ? ((IEnumerable<KeyValuePair<TKey, TValue>>) this._readOnlyDictionary).GetEnumerator() : this._genericDictionary.GetEnumerator();
  }
  ...
  IDictionaryEnumerator IDictionary.GetEnumerator()
  {
    ...
    return this._readOnlyDictionary != null ? (IDictionaryEnumerator) new DictionaryWrapper<TKey, TValue>.DictionaryEnumerator<TKey, TValue>(((IEnumerable<KeyValuePair<TKey, TValue>>) this._readOnlyDictionary).GetEnumerator()) : (IDictionaryEnumerator) new DictionaryWrapper<TKey, TValue>.DictionaryEnumerator<TKey, TValue>(this._genericDictionary.GetEnumerator());
  }
