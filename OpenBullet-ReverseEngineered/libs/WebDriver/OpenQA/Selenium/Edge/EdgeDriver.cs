...
// Type: OpenQA.Selenium.Edge.EdgeDriver
...
public class EdgeDriver : RemoteWebDriver
{
  ...
  public EdgeDriver(EdgeDriverService service, EdgeOptions options, TimeSpan commandTimeout)
    : base((ICommandExecutor) new DriverServiceCommandExecutor((DriverService) service, commandTimeout), EdgeDriver.ConvertOptionsToCapabilities(options))
  {
  }
