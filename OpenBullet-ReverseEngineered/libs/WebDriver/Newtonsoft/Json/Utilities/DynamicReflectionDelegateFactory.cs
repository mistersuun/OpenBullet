...
internal class DynamicReflectionDelegateFactory : ReflectionDelegateFactory
{
  ...
  {
    get => DynamicReflectionDelegateFactory._instance;
  }
  ...
  public override ObjectConstructor<object> CreateParameterizedConstructor(MethodBase method)
  {
    ...
    return (ObjectConstructor<object>) ((MethodInfo) dynamicMethod).CreateDelegate(typeof (ObjectConstructor<object>));
  }
  ...
  public override MethodCall<T, object> CreateMethodCall<T>(MethodBase method)
  {
    ...
    return (MethodCall<T, object>) ((MethodInfo) dynamicMethod).CreateDelegate(typeof (MethodCall<T, object>));
  }
  ...
  public override Func<T> CreateDefaultConstructor<T>(Type type)
  {
    ...
    return (Func<T>) ((MethodInfo) dynamicMethod).CreateDelegate(typeof (Func<T>));
  }
  ...
  public override Func<T, object> CreateGet<T>(PropertyInfo propertyInfo)
  {
    ...
    return (Func<T, object>) ((MethodInfo) dynamicMethod).CreateDelegate(typeof (Func<T, object>));
  }
  ...
  public override Action<T, object> CreateSet<T>(FieldInfo fieldInfo)
  {
    ...
    return (Action<T, object>) ((MethodInfo) dynamicMethod).CreateDelegate(typeof (Action<T, object>));
  }
