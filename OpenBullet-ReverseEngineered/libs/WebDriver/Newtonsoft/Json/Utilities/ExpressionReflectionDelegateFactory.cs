...
internal class ExpressionReflectionDelegateFactory : ReflectionDelegateFactory
{
    ...
    ParameterExpression argsParameterExpression)
  {
    ...
    Expression expression2 = !(methodInfo != (MethodInfo) null) ? this.EnsureCastExpression(expression1, type) : (!(methodInfo.ReturnType != typeof (void)) ? (Expression) Expression.Block(expression1, (Expression) Expression.Constant((object) null)) : this.EnsureCastExpression(expression1, type));
