    ...
    params JsonConverter[] converters)
  {
    ...
    switch (this._valueType)
    {
      ...
      case JTokenType.Integer:
        ...
        return this._value is BigInteger ? writer.WriteValueAsync((object) (BigInteger) this._value, cancellationToken) : writer.WriteValueAsync(Convert.ToInt64(this._value, (IFormatProvider) CultureInfo.InvariantCulture), cancellationToken);
      case JTokenType.Float:
        ...
        return this._value is float ? writer.WriteValueAsync((float) this._value, cancellationToken) : writer.WriteValueAsync(Convert.ToDouble(this._value, (IFormatProvider) CultureInfo.InvariantCulture), cancellationToken);
      ...
      case JTokenType.Date:
        return this._value is DateTimeOffset ? writer.WriteValueAsync((DateTimeOffset) this._value, cancellationToken) : writer.WriteValueAsync(Convert.ToDateTime(this._value, (IFormatProvider) CultureInfo.InvariantCulture), cancellationToken);
      case JTokenType.Raw:
...
label_28:
  ...
  {
    return obj == null ? 1 : JValue.Compare(this._valueType, this._value, obj is JValue jvalue ? jvalue.Value : obj);
  }
