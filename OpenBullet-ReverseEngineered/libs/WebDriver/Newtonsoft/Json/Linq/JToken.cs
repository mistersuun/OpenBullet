  ...
  IDynamicMetaObjectProvider
{
  ...
  public static explicit operator Guid?(JToken value)
  {
    ...
    if (o.Value == null)
      return new Guid?();
    return o.Value is byte[] b ? new Guid?(new Guid(b)) : new Guid?(o.Value is Guid ? (Guid) o.Value : new Guid(Convert.ToString(o.Value, (IFormatProvider) CultureInfo.InvariantCulture)));
  }
