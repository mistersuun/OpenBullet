...
internal class JProperty : JContainer
{
    ...
    params JsonConverter[] converters)
  {
    ...
    return task.Status == TaskStatus.RanToCompletion ? this.WriteValueAsync(writer, cancellationToken, converters) : this.WriteToAsync(task, writer, cancellationToken, converters);
  }
