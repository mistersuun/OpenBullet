...
internal class JsonSerializerInternalWriter(JsonSerializer serializer) : JsonSerializerInternalBase(serializer)
{
  ...
  {
    return ((property.NullValueHandling ?? this.Serializer._nullValueHandling) != NullValueHandling.Ignore || memberValue != null) && (!this.HasFlag(property.DefaultValueHandling ?? this.Serializer._defaultValueHandling, DefaultValueHandling.Ignore) || !MiscellaneousUtils.ValueEquals(memberValue, property.GetResolvedDefaultValue()));
  }
