  ...
  public virtual JsonContract ResolveContract(Type type)
  {
    ...
    if (contractCache1 == null || !contractCache1.TryGetValue(type, out contract))
    {
      ...
      lock (this._typeContractCacheLock)
      {
        ...
        Dictionary<Type, JsonContract> dictionary = contractCache2 != null ? new Dictionary<Type, JsonContract>((IDictionary<Type, JsonContract>) contractCache2) : new Dictionary<Type, JsonContract>();
