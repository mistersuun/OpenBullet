...
{
  internal static string ComObjectExpected => "COM object is expected.";

  internal static string CannotCall => "Cannot perform call.";

  internal static string COMObjectDoesNotSupportEvents => "COM object does not support events.";

  internal static string COMObjectDoesNotSupportSourceInterface
  {
    get => "COM object does not support specified source interface.";
  }

  internal static string SetComObjectDataFailed => "Marshal.SetComObjectData failed.";

  internal static string MethodShouldNotBeCalled
  {
    get => "This method exists only to keep the compiler happy.";
  }

  internal static string UnexpectedVarEnum(object p0)
  {
    return Strings.FormatString("Unexpected VarEnum {0}.", p0);
  }

  internal static string DispBadParamCount(object p0)
  {
    return Strings.FormatString("Error while invoking {0}.", p0);
  }
  ...
  {
    return Strings.FormatString("Error while invoking {0}. Named arguments are not supported.", p0);
  }
  ...
  {
    return Strings.FormatString("Could not convert argument {0} for call to {1}.", p0, p1);
  }

  internal static string DispParamNotOptional(object p0)
  {
    return Strings.FormatString("Error while invoking {0}. A required parameter was omitted.", p0);
  }

  internal static string CannotRetrieveTypeInformation
  {
    get => "ResolveComReference.CannotRetrieveTypeInformation.";
  }

  internal static string GetIDsOfNamesInvalid(object p0)
  {
    return Strings.FormatString("IDispatch::GetIDsOfNames behaved unexpectedly for {0}.", p0);
  }

  internal static string UnsupportedEnumType => "Attempting to wrap an unsupported enum type.";

  internal static string UnsupportedHandlerType
  {
    get => "Attempting to pass an event handler of an unsupported type.";
  }

  internal static string CouldNotGetDispId(object p0, object p1)
  {
    return Strings.FormatString("Could not get dispatch ID for {0} (error: {1}).", p0, p1);
  }

  internal static string AmbiguousConversion(object p0, object p1)
  {
    return Strings.FormatString("There are valid conversions from {0} to {1}.", p0, p1);
  }

  internal static string VariantGetAccessorNYI(object p0)
  {
    return Strings.FormatString("Variant.GetAccessor cannot handle {0}.", p0);
  }
