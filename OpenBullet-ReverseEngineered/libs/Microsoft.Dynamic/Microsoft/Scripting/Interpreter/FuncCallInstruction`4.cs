...
// Type: Microsoft.Scripting.Interpreter.FuncCallInstruction`4
...
internal sealed class FuncCallInstruction<T0, T1, T2, TRet> : CallInstruction
{
  ...
  public FuncCallInstruction(Func<T0, T1, T2, TRet> target) => this._target = target;
  ...
  {
    return (object) this._target(arg0 != null ? (T0) arg0 : default (T0), arg1 != null ? (T1) arg1 : default (T1), arg2 != null ? (T2) arg2 : default (T2));
  }

  public override int Run(InterpretedFrame frame)
  {
    frame.Data[frame.StackIndex - 3] = (object) this._target((T0) frame.Data[frame.StackIndex - 3], (T1) frame.Data[frame.StackIndex - 2], (T2) frame.Data[frame.StackIndex - 1]);
    frame.StackIndex -= 2;
    return 1;
  }
}
