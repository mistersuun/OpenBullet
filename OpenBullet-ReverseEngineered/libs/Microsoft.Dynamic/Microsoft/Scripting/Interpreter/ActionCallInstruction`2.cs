...
// Type: Microsoft.Scripting.Interpreter.ActionCallInstruction`2
...
internal sealed class ActionCallInstruction<T0, T1> : CallInstruction
{
  ...
  public ActionCallInstruction(Action<T0, T1> target) => this._target = target;
  ...
  {
    this._target(arg0 != null ? (T0) arg0 : default (T0), arg1 != null ? (T1) arg1 : default (T1));
    return (object) null;
  }
