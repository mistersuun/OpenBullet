...
// Type: Microsoft.Scripting.Interpreter.DynamicInstruction`10
...
internal class DynamicInstruction<T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet> : Instruction
{
  ...
  {
    return (Instruction) new DynamicInstruction<T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet>(CallSite<Func<CallSite, T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet>>.Create(binder));
  }
  ...
  public override int ConsumedStack => 9;

  public override int Run(InterpretedFrame frame)
  {
    frame.Data[frame.StackIndex - 9] = (object) this._site.Target((CallSite) this._site, (T0) frame.Data[frame.StackIndex - 9], (T1) frame.Data[frame.StackIndex - 8], (T2) frame.Data[frame.StackIndex - 7], (T3) frame.Data[frame.StackIndex - 6], (T4) frame.Data[frame.StackIndex - 5], (T5) frame.Data[frame.StackIndex - 4], (T6) frame.Data[frame.StackIndex - 3], (T7) frame.Data[frame.StackIndex - 2], (T8) frame.Data[frame.StackIndex - 1]);
    frame.StackIndex -= 8;
    return 1;
  }
