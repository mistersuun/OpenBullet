...
// Type: Xceed.Wpf.Toolkit.Converters.SliderThumbWidthConverter
...
public class SliderThumbWidthConverter : IValueConverter
{
  public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
  {
    if (value is Slider)
    {
      ...
      {
        case "0":
          return (object) RangeSlider.GetThumbWidth((Slider) value);
        case "1":
          return (object) RangeSlider.GetThumbHeight((Slider) value);
      }
    }
    return (object) 0.0;
  }
