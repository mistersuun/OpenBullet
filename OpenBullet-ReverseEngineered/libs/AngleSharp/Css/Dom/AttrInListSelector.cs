...
// Type: AngleSharp.Css.Dom.AttrInListSelector
...
internal sealed class AttrInListSelector : BaseAttrSelector, ISelector
{
  ...
  {
    return !string.IsNullOrEmpty(this._value) && (element.GetAttribute(this.Name) ?? string.Empty).SplitSpaces().Contains(this._value, this._comparison);
  }
}
