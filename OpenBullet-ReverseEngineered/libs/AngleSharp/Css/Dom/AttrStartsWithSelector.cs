...
// Type: AngleSharp.Css.Dom.AttrStartsWithSelector
...
internal sealed class AttrStartsWithSelector : BaseAttrSelector, ISelector
{
  ...
  {
    return !string.IsNullOrEmpty(this._value) && (element.GetAttribute(this.Name) ?? string.Empty).StartsWith(this._value, this._comparison);
  }
}
