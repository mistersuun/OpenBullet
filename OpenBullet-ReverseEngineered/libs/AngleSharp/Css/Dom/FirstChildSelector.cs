...
// Type: AngleSharp.Css.Dom.FirstChildSelector
...
internal sealed class FirstChildSelector(int step, int offset, ISelector kind) : 
  ChildSelector(PseudoClassNames.NthChild, step, offset, kind),
  ISelector
{
