...
// Type: AngleSharp.Html.Dom.HtmlTableColgroupElement
...
internal sealed class HtmlTableColgroupElement(Document owner, string prefix = null) : 
  HtmlElement(owner, TagNames.Colgroup, prefix, NodeFlags.Special),
