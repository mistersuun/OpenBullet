...
// Type: IronPython.Compiler.PythonDynamicExpression3
...
internal sealed class PythonDynamicExpression3 : LightDynamicExpression3
{
  ...
  public PythonDynamicExpression3(
  ...
  {
    return this._mode.ReduceDynamic((DynamicMetaObjectBinder) this.Binder, this.Type, this.Argument0, this.Argument1, this.Argument2);
  }
  ...
  protected override Expression Rewrite(
    ...
    Expression arg2)
  {
    return (Expression) new PythonDynamicExpression3(binder, this._mode, arg0, arg1, arg2);
  }
