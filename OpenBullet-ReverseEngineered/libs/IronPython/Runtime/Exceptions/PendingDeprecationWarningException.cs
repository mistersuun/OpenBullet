...
// Type: IronPython.Runtime.Exceptions.PendingDeprecationWarningException
...
public class PendingDeprecationWarningException : WarningException, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.PendingDeprecationWarning);
