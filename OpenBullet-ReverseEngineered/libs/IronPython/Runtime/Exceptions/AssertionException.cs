...
// Type: IronPython.Runtime.Exceptions.AssertionException
...
public class AssertionException : Exception, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.AssertionError);
