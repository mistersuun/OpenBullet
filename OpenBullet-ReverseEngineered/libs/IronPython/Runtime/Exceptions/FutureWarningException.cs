...
// Type: IronPython.Runtime.Exceptions.FutureWarningException
...
public class FutureWarningException : WarningException, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.FutureWarning);
