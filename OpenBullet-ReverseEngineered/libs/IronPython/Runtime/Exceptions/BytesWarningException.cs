...
// Type: IronPython.Runtime.Exceptions.BytesWarningException
...
public class BytesWarningException : WarningException, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.BytesWarning);
