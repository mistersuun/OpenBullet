...
// Type: IronPython.Runtime.Exceptions.UnicodeWarningException
...
public class UnicodeWarningException : WarningException, IPythonAwareException
{
  ...
  object IPythonAwareException.PythonException
  {
    get
    {
      ...
      {
        PythonExceptions.BaseException baseException = new PythonExceptions.BaseException(PythonExceptions.UnicodeWarning);
