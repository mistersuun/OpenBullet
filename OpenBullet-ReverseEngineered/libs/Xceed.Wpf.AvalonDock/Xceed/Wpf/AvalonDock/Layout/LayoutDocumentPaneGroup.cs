...
// Type: Xceed.Wpf.AvalonDock.Layout.LayoutDocumentPaneGroup
...
public class LayoutDocumentPaneGroup : 
  LayoutPositionableGroup<ILayoutDocumentPane>,
  ILayoutDocumentPane,
  ILayoutPanelElement,
  ILayoutElement,
  ...
  ILayoutGroup
{
  ...
  {
    this.Children.Add((ILayoutDocumentPane) documentPane);
  }
  ...
  public override void ConsoleDump(int tab)
  {
    ...
    Trace.WriteLine($"DocumentPaneGroup({this.Orientation})");
    foreach (LayoutElement child in (Collection<ILayoutDocumentPane>) this.Children)
